        ...
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px]">
            ...
            >
              ...
              <div className="mt-[12px] text-center font-[600] text-[16px] text-[#0088FF]">
               {item.salaryMin.toLocaleString("vi-VN")}-{item.salaryMax.toLocaleString("vi-VN")}VND
              </div>
              ...
              <div className="mt-[12px] mb-[20px] mx-[16px] flex flex-wrap justify-center gap-[8px]">
                {item.technologies.map((tech:string,techindex:number)=>{
                  return (
                    ...
                    <div key={techindex} className="border border-[#DEDEDE] rounded-[20px] py-[6px] px-[16px] font-[400] text-[12px] text-[#414042]">
                  {tech}
                </div>
                  )
                })}
