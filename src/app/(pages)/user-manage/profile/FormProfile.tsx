...
export const FormProfile = () => {
  ...
  // Sinh 1 state tạm để hứng cục dữ liệu Form
  ...
  const handleSubmit = (event: any) => {
    ...
    // Nếu có avatar mới append, tránh vứt chuỗi "null" xuống server
    if (avatar) {
        formData.append("avatar", avatar);
    }

    // Gán cất vào state giùm fetch
    setSubmitData(formData);
  }

  // Đây là chìa khóa: Rình lúc cờ isValid bật lên xanh và đã có dữ liệu là lập tức FETCH!
  useEffect(() => {
